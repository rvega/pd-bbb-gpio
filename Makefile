## Pd library beaglebone_gpio version 1.0.14
# For instructions on how to use this beaglebone_gpio, see:
...
ALL_CFLAGS += -DPD -DVERSION='"$(LIBRARY_VERSION)"' -DLIBRARY_NAME='"$(LIBRARY_NAME)"'
